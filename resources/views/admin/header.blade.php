...
<body>
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a class="" href="{{route('admin.addcategory')}}">AddCategory</a></li>
              <li><a class="" href="{{route('admin.addproduct')}}">AddProduct</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;" class="">
  ...
  <<script src="{{asset('admin/js/fullcalendar.min.js')}}"></script>
    ...
    <!-- custom select -->
    <script src="{{asset('admin//jquery.customSelect.min.js')}}"></script>
